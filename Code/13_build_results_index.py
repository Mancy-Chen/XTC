...
MAPPING = [
    ...
    ("ROI raw/adjusted Spearman, normality, permutation", "03_predefined_roi_voxelvolume_behavior.py", "correlations/predefined_roi_voxelvolume"),
    ...
    ("Whole-brain raw/adjusted Spearman, OLS, incremental value", "09_whole_brain_pca_behavior.py", "correlations/whole_brain_pca; OLS_model/whole_brain_pca"),
